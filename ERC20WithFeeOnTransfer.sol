...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, address fundAddress, address managerAddress, uint256 totalSupply_) {  
        _fund = fundAddress;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[fundAddress] = true;
        _mint(fundAddress, totalSupply_);
        _balances[fundAddress] = totalSupply_;
